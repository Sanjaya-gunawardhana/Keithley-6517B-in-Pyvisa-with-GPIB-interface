...
keithley.write(':SENSE:FUNC "VOLT"')  # Set to Voltage measurement mode
keithley.write(':SENSE:CURR:RANGE 200')  # Set current range (e.g., 200 V range)
keithley.write(':SENSE:CURR:NPLC 0.01')  # Set NPLC
...
keithley.write(':TRACE:POINTS 5000')  # Collect 100 data points
keithley.write(':TRIG:COUNT 5000')  # Trigger 100 measurements
